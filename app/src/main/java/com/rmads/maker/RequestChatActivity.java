...
import com.rmads.maker.adapters.ChatAdapter;
import com.rmads.maker.models.ChatMessage;
...
public class RequestChatActivity extends BaseActivity {
    ...
    ChatAdapter adapter;
    com.rmads.maker.models.CustomerRequest customerRequest;
        ...
        FirebaseDatabase.getInstance()
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot s) {
                        customerRequest = s.getValue(com.rmads.maker.models.CustomerRequest.class);
                    }
