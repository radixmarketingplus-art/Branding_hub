...
public class ProfileActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
                ...
                editBtn.setOnClickListener(v -> startActivity(new Intent(this,
                                EditProfileActivity.class)));

                subscriptionBtn.setOnClickListener(v -> startActivity(new Intent(this,
                                SubscriptionActivity.class)));

                settingsBtn.setOnClickListener(v -> startActivity(new Intent(this,
        ...
        void shareApp() {
                String shareMessage = getString(R.string.share_msg_body, getString(R.string.app_name),
                                getPackageName());
